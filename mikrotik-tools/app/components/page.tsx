...
1.  **Klasöre Gidin**: Terminalde \`mikrotik-tools\` klasörüne gidin. \`cd mikrotik-tools\`
2.  **Bağımlılıkları Yükleyin**: \`npm install\`
3.  **API Anahtarını Ayarlayın**: Proje ana dizininde (\`mikrotik-tools\`) \`.env.local\` adında bir dosya oluşturun ve içine API anahtarınızı ekleyin: \`GROQ_API_KEY=sizin_api_anahtarınız\`
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <article className="prose prose-invert prose-blue max-w-none 
                        prose-headings:text-blue-400 prose-h1:text-3xl prose-h1:font-bold prose-h2:border-b prose-h2:border-gray-700 prose-h2:pb-2
                        prose-a:text-blue-400 hover:prose-a:text-blue-500
                        prose-strong:text-white
                        prose-code:bg-gray-700 prose-code:px-1.5 prose-code:py-1 prose-code:rounded prose-code:text-blue-300
                        prose-pre:bg-black prose-pre:p-4 prose-pre:rounded-lg prose-pre:border prose-pre:border-gray-700
